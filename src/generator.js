...
- MONUMENTS NON HABITABLES : si type_batiment évoque un ARC (arc_de_triomphe, arche, porte_de_ville, aqueduc) → utilise la primitive "arche" comme corps principal (JAMAIS une simple boite pleine qui ressemblerait à une prison). Si type_batiment évoque une TOUR ISOLÉE monumentale (tour_eiffel, big_ben, tour_pise, minaret) → primitive "tour" avec toit_conique et créneaux. Si c'est un OBÉLISQUE / colonne / stèle → empile 2-3 boites étroites décroissantes. Pour ces monuments : PAS de porte, PAS de cloisons intérieures, PAS d'audit habitabilité applicable — la fidélité de la silhouette prime sur l'habitabilité.
